...
class Carrier(Moving):
    ...
    #Which line the Carrier is running
    _line = 0

    #Amount of passengers on Carrier
    _passengers = 0

    #Speed of Carrier
    _speed = 0
    
    #Max speed of the carrier in m/s
    #TODO this paramater needs to be changed
    _maxSpeed = 33.33
    
    #Max speed the carrier can go before it needs to decelerate again
    _accelerateTo = 0

    #Acceleration of carrier
    #TODO these paramaters need to be changed
    _acceleration = 1.3
    _deceleration = 1.2
    ...
    #TODO need to acquire the carrier's information 
    def loadFromJSON(json):
       # return Train(json['uid'],json['atStation'],json['moveTo'])
        pass


    #If the station is close, the carrier can only accelerate so much
    ...
    #TODO carriers have the maximum capacity
    ...
    #Return a tuple consisting of the station the carrier came from and the station the carrier is at
    ...
    # carrier does not yet have a line
    #TODO does the carriers also have a line?
    def getLine(self):
        return self._line
